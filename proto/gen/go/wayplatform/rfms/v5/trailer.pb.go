...
// 	protoc        (unknown)
// source: wayplatform/rfms/v5/trailer.proto
...
func (Trailer_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_rfms_v5_trailer_proto_enumTypes[0].Descriptor()
}

func (Trailer_Type) Type() protoreflect.EnumType {
	return &file_wayplatform_rfms_v5_trailer_proto_enumTypes[0]
}
...
func (x *Trailer) Reset() {
	*x = Trailer{}
	mi := &file_wayplatform_rfms_v5_trailer_proto_msgTypes[0]
...
func (x *Trailer_Axle) Reset() {
	*x = Trailer_Axle{}
	mi := &file_wayplatform_rfms_v5_trailer_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_wayplatform_rfms_v5_trailer_proto protoreflect.FileDescriptor
...
var file_wayplatform_rfms_v5_trailer_proto_goTypes = []any{
...
func file_wayplatform_rfms_v5_trailer_proto_init() {
	if File_wayplatform_rfms_v5_trailer_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_rfms_v5_trailer_proto_rawDesc), len(file_wayplatform_rfms_v5_trailer_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_rfms_v5_trailer_proto_goTypes,
		DependencyIndexes: file_wayplatform_rfms_v5_trailer_proto_depIdxs,
		EnumInfos:         file_wayplatform_rfms_v5_trailer_proto_enumTypes,
		MessageInfos:      file_wayplatform_rfms_v5_trailer_proto_msgTypes,
	}.Build()
	File_wayplatform_rfms_v5_trailer_proto = out.File
	file_wayplatform_rfms_v5_trailer_proto_goTypes = nil
	file_wayplatform_rfms_v5_trailer_proto_depIdxs = nil
}
