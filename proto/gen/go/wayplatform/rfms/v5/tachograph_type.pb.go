...
// 	protoc        (unknown)
// source: wayplatform/rfms/v5/tachograph_type.proto
...
func (TachographType) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_rfms_v5_tachograph_type_proto_enumTypes[0].Descriptor()
}

func (TachographType) Type() protoreflect.EnumType {
	return &file_wayplatform_rfms_v5_tachograph_type_proto_enumTypes[0]
}
...
var File_wayplatform_rfms_v5_tachograph_type_proto protoreflect.FileDescriptor

const file_wayplatform_rfms_v5_tachograph_type_proto_rawDesc = "" +
	"\n" +
	...
	"\x17com.wayplatform.rfms.v5B\x13TachographTypeProtoP\x01ZGgithub.com/way-platform/rfms-go/proto/gen/go/wayplatform/rfms/v5;rfmsv5\xa2\x02\x03WRX\xaa\x02\x13Wayplatform.Rfms.V5\xca\x02\x13Wayplatform\\Rfms\\V5\xe2\x02\x1fWayplatform\\Rfms\\V5\\GPBMetadata\xea\x02\x15Wayplatform::Rfms::V5b\beditionsp\xe8\a"

var file_wayplatform_rfms_v5_tachograph_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_wayplatform_rfms_v5_tachograph_type_proto_goTypes = []any{
	(TachographType)(0), // 0: wayplatform.rfms.v5.TachographType
}
var file_wayplatform_rfms_v5_tachograph_type_proto_depIdxs = []int32{
...
func init() { file_wayplatform_rfms_v5_tachograph_type_proto_init() }
func file_wayplatform_rfms_v5_tachograph_type_proto_init() {
	if File_wayplatform_rfms_v5_tachograph_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_rfms_v5_tachograph_type_proto_rawDesc), len(file_wayplatform_rfms_v5_tachograph_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_rfms_v5_tachograph_type_proto_goTypes,
		DependencyIndexes: file_wayplatform_rfms_v5_tachograph_type_proto_depIdxs,
		EnumInfos:         file_wayplatform_rfms_v5_tachograph_type_proto_enumTypes,
	}.Build()
	File_wayplatform_rfms_v5_tachograph_type_proto = out.File
	file_wayplatform_rfms_v5_tachograph_type_proto_goTypes = nil
	file_wayplatform_rfms_v5_tachograph_type_proto_depIdxs = nil
}
