...
// 	protoc        (unknown)
// source: wayplatform/rfms/v5/snapshot_data.proto
...
func (x *SnapshotData) Reset() {
	*x = SnapshotData{}
	mi := &file_wayplatform_rfms_v5_snapshot_data_proto_msgTypes[0]
...
func (x *SnapshotData_EstimatedDistanceToEmpty) Reset() {
	*x = SnapshotData_EstimatedDistanceToEmpty{}
	mi := &file_wayplatform_rfms_v5_snapshot_data_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func init() { file_wayplatform_rfms_v5_snapshot_data_proto_init() }
func file_wayplatform_rfms_v5_snapshot_data_proto_init() {
	...
	file_wayplatform_rfms_v5_driver_working_state_proto_init()
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_rfms_v5_snapshot_data_proto_rawDesc), len(file_wayplatform_rfms_v5_snapshot_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_rfms_v5_snapshot_data_proto_goTypes,
		DependencyIndexes: file_wayplatform_rfms_v5_snapshot_data_proto_depIdxs,
		MessageInfos:      file_wayplatform_rfms_v5_snapshot_data_proto_msgTypes,
	}.Build()
	File_wayplatform_rfms_v5_snapshot_data_proto = out.File
	file_wayplatform_rfms_v5_snapshot_data_proto_goTypes = nil
	file_wayplatform_rfms_v5_snapshot_data_proto_depIdxs = nil
}
