...
// 	protoc        (unknown)
// source: wayplatform/rfms/v5/date.proto
...
func (x *Date) Reset() {
	*x = Date{}
	mi := &file_wayplatform_rfms_v5_date_proto_msgTypes[0]
...
var File_wayplatform_rfms_v5_date_proto protoreflect.FileDescriptor

const file_wayplatform_rfms_v5_date_proto_rawDesc = "" +
	"\n" +
	"\x1ewayplatform/rfms/v5/date.proto\x12\x13wayplatform.rfms.v5\"B\n" +
	"\x04Date\x12\x10\n" +
...
var file_wayplatform_rfms_v5_date_proto_depIdxs = []int32{
...
func init() { file_wayplatform_rfms_v5_date_proto_init() }
func file_wayplatform_rfms_v5_date_proto_init() {
	if File_wayplatform_rfms_v5_date_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_rfms_v5_date_proto_rawDesc), len(file_wayplatform_rfms_v5_date_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_rfms_v5_date_proto_goTypes,
		DependencyIndexes: file_wayplatform_rfms_v5_date_proto_depIdxs,
		MessageInfos:      file_wayplatform_rfms_v5_date_proto_msgTypes,
	}.Build()
	File_wayplatform_rfms_v5_date_proto = out.File
	file_wayplatform_rfms_v5_date_proto_goTypes = nil
	file_wayplatform_rfms_v5_date_proto_depIdxs = nil
}
