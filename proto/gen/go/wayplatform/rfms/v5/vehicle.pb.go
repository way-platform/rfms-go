...
type Vehicle struct {
	...
	xxx_hidden_NoOfAxles                      int32                  `protobuf:"varint,16,opt,name=no_of_axles,json=noOfAxles"`
...
func (x *Vehicle) SetNoOfAxles(v int32) {
	x.xxx_hidden_NoOfAxles = v
...
func (x *Vehicle) HasNoOfAxles() bool {
	if x == nil {
		return false
	}
...
func (x *Vehicle) ClearNoOfAxles() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 15)
	x.xxx_hidden_NoOfAxles = 0
}
...
func (b0 Vehicle_builder) Build() *Vehicle {
	...
	if b.NoOfAxles != nil {
		...
		x.xxx_hidden_NoOfAxles = *b.NoOfAxles
	}
...
const file_wayplatform_rfms_v5_vehicle_proto_rawDesc = "" +
	...
	"\fchassis_type\x18\x0f \x01(\tR\vchassisType\x12\x1e\n" +
	"\vno_of_axles\x18\x10 \x01(\x05R\tnoOfAxles\x128\n" +
