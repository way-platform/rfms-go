...
// 	protoc        (unknown)
// source: wayplatform/rfms/v5/vehicle_axle.proto
...
func (x *VehicleAxle) Reset() {
	*x = VehicleAxle{}
	mi := &file_wayplatform_rfms_v5_vehicle_axle_proto_msgTypes[0]
...
func (x *VehicleAxle_Tire) Reset() {
	*x = VehicleAxle_Tire{}
	mi := &file_wayplatform_rfms_v5_vehicle_axle_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_wayplatform_rfms_v5_vehicle_axle_proto protoreflect.FileDescriptor

const file_wayplatform_rfms_v5_vehicle_axle_proto_rawDesc = "" +
	"\n" +
	...
	"\fpressure_kpa\x18\x02 \x01(\x01R\vpressureKpaB\xe2\x01\n" +
	"\x17com.wayplatform.rfms.v5B\x10VehicleAxleProtoP\x01ZGgithub.com/way-platform/rfms-go/proto/gen/go/wayplatform/rfms/v5;rfmsv5\xa2\x02\x03WRX\xaa\x02\x13Wayplatform.Rfms.V5\xca\x02\x13Wayplatform\\Rfms\\V5\xe2\x02\x1fWayplatform\\Rfms\\V5\\GPBMetadata\xea\x02\x15Wayplatform::Rfms::V5b\beditionsp\xe8\a"

var file_wayplatform_rfms_v5_vehicle_axle_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_wayplatform_rfms_v5_vehicle_axle_proto_goTypes = []any{
	(*VehicleAxle)(nil),      // 0: wayplatform.rfms.v5.VehicleAxle
	(*VehicleAxle_Tire)(nil), // 1: wayplatform.rfms.v5.VehicleAxle.Tire
}
var file_wayplatform_rfms_v5_vehicle_axle_proto_depIdxs = []int32{
...
func init() { file_wayplatform_rfms_v5_vehicle_axle_proto_init() }
func file_wayplatform_rfms_v5_vehicle_axle_proto_init() {
	if File_wayplatform_rfms_v5_vehicle_axle_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_rfms_v5_vehicle_axle_proto_rawDesc), len(file_wayplatform_rfms_v5_vehicle_axle_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_rfms_v5_vehicle_axle_proto_goTypes,
		DependencyIndexes: file_wayplatform_rfms_v5_vehicle_axle_proto_depIdxs,
		MessageInfos:      file_wayplatform_rfms_v5_vehicle_axle_proto_msgTypes,
	}.Build()
	File_wayplatform_rfms_v5_vehicle_axle_proto = out.File
	file_wayplatform_rfms_v5_vehicle_axle_proto_goTypes = nil
	file_wayplatform_rfms_v5_vehicle_axle_proto_depIdxs = nil
}
