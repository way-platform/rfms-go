...
// 	protoc        (unknown)
// source: wayplatform/connect/rfms/v5/charging_state.proto
...
func (ChargingState) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_connect_rfms_v5_charging_state_proto_enumTypes[0].Descriptor()
}

func (ChargingState) Type() protoreflect.EnumType {
	return &file_wayplatform_connect_rfms_v5_charging_state_proto_enumTypes[0]
}
...
var File_wayplatform_connect_rfms_v5_charging_state_proto protoreflect.FileDescriptor

const file_wayplatform_connect_rfms_v5_charging_state_proto_rawDesc = "" +
	"\n" +
	"0wayplatform/connect/rfms/v5/charging_state.proto\x12\x1bwayplatform.connect.rfms.v5*\xc9\x01\n" +
	...
	"\vCHARGING_DC\x10\aB\x95\x02\n" +
	"\x1fcom.wayplatform.connect.rfms.v5B\x12ChargingStateProtoP\x01ZOgithub.com/way-platform/rfms-go/proto/gen/go/wayplatform/connect/rfms/v5;rfmsv5\xa2\x02\x03WCR\xaa\x02\x1bWayplatform.Connect.Rfms.V5\xca\x02\x1bWayplatform\\Connect\\Rfms\\V5\xe2\x02'Wayplatform\\Connect\\Rfms\\V5\\GPBMetadata\xea\x02\x1eWayplatform::Connect::Rfms::V5b\beditionsp\xe8\a"

var file_wayplatform_connect_rfms_v5_charging_state_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_wayplatform_connect_rfms_v5_charging_state_proto_goTypes = []any{
	(ChargingState)(0), // 0: wayplatform.connect.rfms.v5.ChargingState
}
var file_wayplatform_connect_rfms_v5_charging_state_proto_depIdxs = []int32{
...
func init() { file_wayplatform_connect_rfms_v5_charging_state_proto_init() }
func file_wayplatform_connect_rfms_v5_charging_state_proto_init() {
	if File_wayplatform_connect_rfms_v5_charging_state_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_rfms_v5_charging_state_proto_rawDesc), len(file_wayplatform_connect_rfms_v5_charging_state_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_rfms_v5_charging_state_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_rfms_v5_charging_state_proto_depIdxs,
		EnumInfos:         file_wayplatform_connect_rfms_v5_charging_state_proto_enumTypes,
	}.Build()
	File_wayplatform_connect_rfms_v5_charging_state_proto = out.File
	file_wayplatform_connect_rfms_v5_charging_state_proto_goTypes = nil
	file_wayplatform_connect_rfms_v5_charging_state_proto_depIdxs = nil
}
