...
// 	protoc        (unknown)
// source: wayplatform/connect/rfms/v5/gnss_position.proto
...
func (x *GnssPosition) Reset() {
	*x = GnssPosition{}
	mi := &file_wayplatform_connect_rfms_v5_gnss_position_proto_msgTypes[0]
...
var File_wayplatform_connect_rfms_v5_gnss_position_proto protoreflect.FileDescriptor
...
func file_wayplatform_connect_rfms_v5_gnss_position_proto_init() {
	if File_wayplatform_connect_rfms_v5_gnss_position_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_rfms_v5_gnss_position_proto_rawDesc), len(file_wayplatform_connect_rfms_v5_gnss_position_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_rfms_v5_gnss_position_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_rfms_v5_gnss_position_proto_depIdxs,
		MessageInfos:      file_wayplatform_connect_rfms_v5_gnss_position_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_rfms_v5_gnss_position_proto = out.File
	file_wayplatform_connect_rfms_v5_gnss_position_proto_goTypes = nil
	file_wayplatform_connect_rfms_v5_gnss_position_proto_depIdxs = nil
}
