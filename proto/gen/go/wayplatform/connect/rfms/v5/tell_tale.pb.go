...
// 	protoc        (unknown)
// source: wayplatform/connect/rfms/v5/tell_tale.proto
...
func (TellTale_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_connect_rfms_v5_tell_tale_proto_enumTypes[0].Descriptor()
}

func (TellTale_Type) Type() protoreflect.EnumType {
	return &file_wayplatform_connect_rfms_v5_tell_tale_proto_enumTypes[0]
}
...
func (TellTale_State) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_connect_rfms_v5_tell_tale_proto_enumTypes[1].Descriptor()
}

func (TellTale_State) Type() protoreflect.EnumType {
	return &file_wayplatform_connect_rfms_v5_tell_tale_proto_enumTypes[1]
}
...
func (x *TellTale) Reset() {
	*x = TellTale{}
	mi := &file_wayplatform_connect_rfms_v5_tell_tale_proto_msgTypes[0]
...
var File_wayplatform_connect_rfms_v5_tell_tale_proto protoreflect.FileDescriptor
...
func init() { file_wayplatform_connect_rfms_v5_tell_tale_proto_init() }
func file_wayplatform_connect_rfms_v5_tell_tale_proto_init() {
	if File_wayplatform_connect_rfms_v5_tell_tale_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_rfms_v5_tell_tale_proto_rawDesc), len(file_wayplatform_connect_rfms_v5_tell_tale_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_rfms_v5_tell_tale_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_rfms_v5_tell_tale_proto_depIdxs,
		EnumInfos:         file_wayplatform_connect_rfms_v5_tell_tale_proto_enumTypes,
		MessageInfos:      file_wayplatform_connect_rfms_v5_tell_tale_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_rfms_v5_tell_tale_proto = out.File
	file_wayplatform_connect_rfms_v5_tell_tale_proto_goTypes = nil
	file_wayplatform_connect_rfms_v5_tell_tale_proto_depIdxs = nil
}
