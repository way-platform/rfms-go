...
// 	protoc        (unknown)
// source: wayplatform/connect/rfms/v5/driver_identification.proto
...
func (DriverIdentification_Tacho_AuthenticationEquipment) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_connect_rfms_v5_driver_identification_proto_enumTypes[0].Descriptor()
}

func (DriverIdentification_Tacho_AuthenticationEquipment) Type() protoreflect.EnumType {
	return &file_wayplatform_connect_rfms_v5_driver_identification_proto_enumTypes[0]
}
...
func (x *DriverIdentification) Reset() {
	*x = DriverIdentification{}
	mi := &file_wayplatform_connect_rfms_v5_driver_identification_proto_msgTypes[0]
...
func (x *DriverIdentification_Tacho) Reset() {
	*x = DriverIdentification_Tacho{}
	mi := &file_wayplatform_connect_rfms_v5_driver_identification_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DriverIdentification_Oem) Reset() {
	*x = DriverIdentification_Oem{}
	mi := &file_wayplatform_connect_rfms_v5_driver_identification_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_wayplatform_connect_rfms_v5_driver_identification_proto protoreflect.FileDescriptor
...
func init() { file_wayplatform_connect_rfms_v5_driver_identification_proto_init() }
func file_wayplatform_connect_rfms_v5_driver_identification_proto_init() {
	if File_wayplatform_connect_rfms_v5_driver_identification_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_rfms_v5_driver_identification_proto_rawDesc), len(file_wayplatform_connect_rfms_v5_driver_identification_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_rfms_v5_driver_identification_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_rfms_v5_driver_identification_proto_depIdxs,
		EnumInfos:         file_wayplatform_connect_rfms_v5_driver_identification_proto_enumTypes,
		MessageInfos:      file_wayplatform_connect_rfms_v5_driver_identification_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_rfms_v5_driver_identification_proto = out.File
	file_wayplatform_connect_rfms_v5_driver_identification_proto_goTypes = nil
	file_wayplatform_connect_rfms_v5_driver_identification_proto_depIdxs = nil
}
