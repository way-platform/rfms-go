...
// 	protoc        (unknown)
// source: wayplatform/connect/rfms/v5/uptime_data.proto
...
func (UptimeData_Alternator_State) Descriptor() protoreflect.EnumDescriptor {
	return file_wayplatform_connect_rfms_v5_uptime_data_proto_enumTypes[0].Descriptor()
}

func (UptimeData_Alternator_State) Type() protoreflect.EnumType {
	return &file_wayplatform_connect_rfms_v5_uptime_data_proto_enumTypes[0]
}
...
func (x *UptimeData) Reset() {
	*x = UptimeData{}
	mi := &file_wayplatform_connect_rfms_v5_uptime_data_proto_msgTypes[0]
...
func (x *UptimeData_Alternator) Reset() {
	*x = UptimeData_Alternator{}
	mi := &file_wayplatform_connect_rfms_v5_uptime_data_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_wayplatform_connect_rfms_v5_uptime_data_proto protoreflect.FileDescriptor
...
func init() { file_wayplatform_connect_rfms_v5_uptime_data_proto_init() }
func file_wayplatform_connect_rfms_v5_uptime_data_proto_init() {
	if File_wayplatform_connect_rfms_v5_uptime_data_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_rfms_v5_uptime_data_proto_rawDesc), len(file_wayplatform_connect_rfms_v5_uptime_data_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_rfms_v5_uptime_data_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_rfms_v5_uptime_data_proto_depIdxs,
		EnumInfos:         file_wayplatform_connect_rfms_v5_uptime_data_proto_enumTypes,
		MessageInfos:      file_wayplatform_connect_rfms_v5_uptime_data_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_rfms_v5_uptime_data_proto = out.File
	file_wayplatform_connect_rfms_v5_uptime_data_proto_goTypes = nil
	file_wayplatform_connect_rfms_v5_uptime_data_proto_depIdxs = nil
}
