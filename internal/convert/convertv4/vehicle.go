...
// Vehicle converts an rFMS v4 vehicle to proto.
func Vehicle(input *rfmsv4oapi.VehicleObject) *rfmsv5.Vehicle {
	...
	if input.TotalFuelTankCapacityGaseous != nil {
		output.SetTotalFuelTankCapacityGaseousKg(float64(*input.TotalFuelTankCapacityGaseous))
	}
	if input.TotalBatteryPackCapacity != nil {
	...
	if input.DoorConfiguration != nil {
